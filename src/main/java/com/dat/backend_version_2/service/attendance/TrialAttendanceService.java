...
public class TrialAttendanceService {
    ...
    @Transactional
    public void markAttendance(AttendanceDTO attendanceDTO, String idUser
        ...
        Registration registration = registrationService
                .getRegistrationById(attendanceDTO.getIdStudent());
    ...
    public TrialAttendance getTrialAttendanceById(String idAttendance) throws IdInvalidException {
        return trialAttendanceRepository.findById(UUID.fromString(idAttendance))
                .orElseThrow(() -> new IdInvalidException("TrialAttendance not found with id: " + idAttendance));
    }

    public void markEvaluation(AttendanceDTO.MarkEvaluation markEvaluation, String idAccount
    ) throws IdInvalidException {
        TrialAttendance trialAttendance = getTrialAttendanceById(markEvaluation.getIdAttendance());
